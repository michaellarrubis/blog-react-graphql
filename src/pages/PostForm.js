      ...
      <div className="u-container">
        <form className="post-form-inner" onSubmit={handleSubmitPost}>
          ...
          <div className="post-body">
            ...
            <div
              className={
                isTitleEmpty ? "post-form-title error" : "post-form-title"
              }
            >
              <textarea
                id="title"
            ...
            >
              <label htmlFor="image-upload" className="post-form-image-label">
        ...
        <div className="post-footer">{handleCommentSection}</div>
      </div>
    </div>
  );
};
