    ...
    return (
        <div className="carousel">
            <div className="carousel-indicator">
                {
                    slideData?.map((slide, index) =>
                        <div 
                            key={index}
                            className={
                                index === activeIndex ? "carousel-indicator-item is-active" : "carousel-indicator-item"
                            }
            ...
            <div className="carousel-slides">
                <div className="carousel-navigate carousel-navigate-left" id="prev" onClick={e => navigateToSlide(e)}>
                    <div className="navigate navigate-left"/>
                </div>

                <div className="carousel-list" style={{marginLeft: marginLeft[activeIndex]}}>
                    {
                        slideData?.map((slide, index) =>
                            <div 
                ...
                <div className="carousel-navigate carousel-navigate-right" id="next" onClick={e => navigateToSlide(e)}>
